...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python run_analysis.py <amazon_url> [--max-products N] [--max-competitive N]")
        print("Example: python run_analysis.py https://www.amazon.com/dp/B08B9H2ZYT --max-products 5 --max-competitive 3")
        return 1
    
    # Import here to avoid circular imports and ensure argparse is used
    from langchain_app.main import ArgumentParser
    ...
    try:
        ...
        print(f"Max products: {args.max_products}, Max competitive products: {args.max_competitive}")
