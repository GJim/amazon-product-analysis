...
class SupervisorAgent(BaseAgent):
    ...
    def _format_state_for_prompt(self, state: GraphState) -> str:
        ...
        if state.get("main_product"):
            ...
            summary_parts.append(f"Main product: {main_product.title} (Price: {main_product.price})")
        else:
        ...
        summary_parts.append(f"Competitive products: {len(competitive_products)} collected")
